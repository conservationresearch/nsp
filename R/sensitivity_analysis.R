...
sensitivity <- function(org_programs, inputs, results_full_analysis, rank_cutoff){
  ...
  inputs_sens$difference_in_ranks_overall_minus_low_national <- as.numeric(inputs_sens$BCR_national_EV_overall) - as.numeric(inputs_sens$BCR_national_EV_low)
  inputs_sens$difference_in_ranks_overall_minus_high_national <- as.numeric(inputs_sens$BCR_national_EV_overall) - as.numeric(inputs_sens$BCR_national_EV_high)
  ...
  #National
  inputs_sens$decision_sensitive_national <- "No" # initalize
  inputs_sens$decision_sensitive_national[which(as.numeric(inputs_sens$BCR_national_EV_rank_overall) <= rank_cutoff & as.numeric(inputs_sens$BCR) >rank_cutoff)] <- paste("Yes - in top", rank_cutoff, "overall but could be out")
  inputs_sens$decision_sensitive_national[which(as.numeric(inputs_sens$BCR_national_EV_rank_overall) <= rank_cutoff & as.numeric(inputs_sens$weighted_BCR_rank_high) >rank_cutoff)] <- paste("Yes - in top", rank_cutoff, "overall but could be out")
  inputs_sens$decision_sensitive_national[which(as.numeric(inputs_sens$BCR_national_EV_rank_overall) > rank_cutoff & as.numeric(inputs_sens$weighted_BCR_rank_low) <=rank_cutoff)] <- paste("Yes - out of top", rank_cutoff, "overall but could be in")
  inputs_sens$decision_sensitive_national[which(as.numeric(inputs_sens$BCR_national_EV_rank_overall) > rank_cutoff & as.numeric(inputs_sens$weighted_BCR_rank_high) <=rank_cutoff)] <- paste("Yes - out of top", rank_cutoff, "overall but could be in")
  #Global
  inputs_sens$decision_sensitive_global <- "No" # initalize
  inputs_sens$decision_sensitive_global[which(as.numeric(inputs_sens$weighted_BCR_rank_overall) <= rank_cutoff & as.numeric(inputs_sens$weighted_BCR_rank_low) >rank_cutoff)] <- paste("Yes - in top", rank_cutoff, "overall but could be out")
